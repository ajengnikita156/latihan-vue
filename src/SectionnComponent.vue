...
<ol class="items-center sm:flex">
    ...
    <center><p class="text-base font-normal text-gray-500 dark:text-gray-400">Produk BEST SELLER yang diminati dan dibutuhkan banyak orang</p></center>
        ...
        <br>
        <center><button type="button" class="focus:outline-none text-white bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:focus:ring-yellow-900">Selengkapnya</button></center>
